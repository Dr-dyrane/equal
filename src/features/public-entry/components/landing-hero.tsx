...
export function LandingHero({ content, signals }: LandingHeroProps) {
  return (
    <div className="story-reveal mx-auto flex w-full max-w-[56rem] flex-col items-center space-y-5 text-center">
      ...
      <div className="story-hero-mark bg-black rounded-full p-5">
        <Image
          src="/brand/hero.png"
          ...
          className="story-hero-mark-image h-auto w-[80px] sm:w-[96px] lg:w-[112px] xl:w-[120px]"
        />
      </div>

      <div className="flex flex-col gap-2 space-y-2 mb-10">
        ...
        <p className="text-balance font-heading text-[1rem] leading-[0.9] text-[color:var(--story-subtle)] sm:text-[2rem] lg:text-[3rem] xl:text-[4rem]">
          {content.secondaryHeadline}
        </p>
      </div>

      <div className="flex w-full max-w-[24rem] items-center justify-center mb-10">
        <Link
          href="/demo"
