...
const fairnessLedger = [
  ...
  },
  {
    name: "Lena Park",
    shifts: "1 holiday",
    trend: "+1 credit banked",
    tone: "text-fuchsia-700",
  },
  {
    name: "Owen Diaz",
    shifts: "4 overtime hrs",
    trend: "monitor next cycle",
    ...
    <div className="flex flex-col gap-6">
      <section className="glass-panel-strong grid gap-6 overflow-hidden p-6 lg:grid-cols-[1.15fr_0.85fr] lg:p-8">
        <div className="relative z-10 flex flex-col gap-5">
          <span className="metric-chip w-fit">Workspace overview</span>
              ...
              {fairnessLedger.map((entry) => (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span
                      className={`text-xs font-semibold uppercase tracking-[0.16em] ${entry.tone}`}
                    >
                      {entry.trend}
                    </span>
                  </div>
